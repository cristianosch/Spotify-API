...
# First of all you need to get your id on developers.spotify, to get that you have to create a app

# Get the access in .env
...
token = get_token()
name_artist = input('Which artist do you have in mind ? ')
